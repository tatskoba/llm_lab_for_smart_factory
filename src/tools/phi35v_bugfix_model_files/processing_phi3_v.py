...
class Phi3VProcessor(ProcessorMixin):
    ...
    ### def __init__(self, image_processor, tokenizer):          # Delete 2025/4/14
    def __init__(self, image_processor, tokenizer, **kwargs):    # Added 2025/4/14　See https://huggingface.co/microsoft/Phi-3.5-vision-instruct/commit/10303160fd7605db33fe7e4ce9e5a8f5f27889c1#d2h-094254
