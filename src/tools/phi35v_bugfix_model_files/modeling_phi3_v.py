    ...
    def prepare_inputs_for_generation(
        ...
        if past_key_values is not None:
            if isinstance(past_key_values, Cache):
                ...
                # max_cache_length = past_key_values.get_max_length()       ### Delete 2025/4/13  See https://huggingface.co/microsoft/Phi-3.5-vision-instruct/commit/dfc36d84e079f4d99c654f1cc489e0970f5917c0
                max_cache_length = past_key_values.get_max_cache_shape()    ### Added 2025/4/13
            else:
